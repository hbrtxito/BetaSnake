...
public class Snake {
	...
	//I change it to one .. Since I like the game longer
	...
	protected void createStartSnake(){
		...
		// snake start with 3 squares
		snakeSize = 3;
		//Direction to where the snake start moving
...
//These methods are to ensure that the snake does not collapse with its own body
	public void snakeUp(){
	...
	protected void moveSnake(){
		...
		if (currentHeading == DIRECTION_RIGHT) {		
			...
			snakeHeadX ++ ;
                ...
                //-------------------------------------------------
                //Modify this block , so the snake can goes trough the wall
...
//                  Take out  the condition to make the snake die when it hits the wall
//                  hitWall = true;	
//                  SnakeGame.setGameStage(SnakeGame.GAME_OVER);
//                  return;
		}
